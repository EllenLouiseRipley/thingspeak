...
gem 'twitter_oauth', github: 'moomerman/twitter_oauth'
gem 'therubyracer'
...
gem 'simplificator-rwebthumb', github: 'simplificator/rwebthumb'
gem 'tweetstream'
gem 'capistrano', '~> 2.15.4'
gem 'rack-utf8_sanitizer'
gem 'newrelic_rpm'
gem 'actionpack-xml_parser'
#gem 'activeadmin', github: 'steverdrew/active_admin'
